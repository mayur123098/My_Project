...
public class CinemaBooking {
    ...
    // Scanner and other shared variables as static members of the class
    ...
    // Method for the welcome screen and initial prompt
    ...
    // Method to handle movie selection and ticket booking
    public static void selectMovieAndBookTickets() {
        ...
        switch (movie_num) {
            ...
            default:
                ...
                return; // Exit if movie selection is invalid
        }
        ...
        if (timeChoice == 1) {
            ...
            return; // Exit if showtime selection is invalid
        }
        ...
        ticketTotal = 0; // Reset ticketTotal for fresh calculation
        if (cat == 1) {
        ...
        bookingID = rand.nextInt(9000) + 1000; // Generate 4-digit booking ID
    ...
    // Method to handle food menu and order
    public static void orderFood() {
        foodTotal = 0; // Reset foodTotal for fresh calculation
        System.out.println("\n=== Food Menu ===");
    ...
    public static void main(String[] args) {
        ...
        createAccount();          // Step 1: Create an account
        login();                  // Step 2: Login
        welcomeScreen();          // Step 3: Display welcome and prompt to continue
        selectMovieAndBookTickets(); // Step 4: Select movie and book tickets
        orderFood();              // Step 5: Order food
        displayFinalBill();       // Step 6: Display final bill
